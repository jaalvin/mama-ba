...
export const CONFIG = {
  ...
  ABENA_KEY_1: process.env.ABENA_KEY_1 || 'sk_dd2ff64591ce480dab9a23db4388b7e3',
  ABENA_KEY_2: process.env.ABENA_KEY_2 || 'sk_97455e7a1c014464b09fc104546c3bcb',
  ABENA_KEY_3: process.env.ABENA_KEY_3 || 'sk_d953bf290d394798baa9882dc82d95f5',
  ABENA_KEY_4: process.env.ABENA_KEY_4 || 'sk_6e293b7a2f92431a85a40814a211abcb',
  ABENA_API_KEY: process.env.ABENA_API_KEY || 'sk_dd2ff64591ce480dab9a23db4388b7e3',
  ABENA_FALLBACK_API_KEY: process.env.ABENA_FALLBACK_API_KEY || 'sk_97455e7a1c014464b09fc104546c3bcb',
