...
export const CONFIG = {
  ...
  ABENA_KEY_1: process.env.ABENA_KEY_1 || 'sk_e2812cf49744446f9377040095eebecc',
  ABENA_KEY_2: process.env.ABENA_KEY_2 || 'sk_f43c5bf516e84e038f7b955f77d667bd',
  ...
  ABENA_API_KEY: process.env.ABENA_API_KEY || 'sk_e2812cf49744446f9377040095eebecc',
  ABENA_FALLBACK_API_KEY: process.env.ABENA_FALLBACK_API_KEY || 'sk_f43c5bf516e84e038f7b955f77d667bd',
