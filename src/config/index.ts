...
export const CONFIG = {
  ...
  ABENA_KEY_1: process.env.ABENA_KEY_1 || 'sk_b66230787fc54e8ba63b3084a7370521',
  ABENA_KEY_2: process.env.ABENA_KEY_2 || 'sk_a47fce0855e54740887c863fa268e423',
  ABENA_KEY_3: process.env.ABENA_KEY_3 || 'sk_99e14864877b47f7a121313b87602aec',
  ABENA_KEY_4: process.env.ABENA_KEY_4 || 'sk_23d2b9e5b24c4ab7ae82bc2dc105491c',
  ABENA_KEY_5: process.env.ABENA_KEY_5 || 'sk_b18d6bafae8a4160bbfc8639a593051e',
  ABENA_KEY_6: process.env.ABENA_KEY_6 || 'sk_062ac4b25cc44479b6eda14e4a0f1f7d',
  ABENA_API_KEY: process.env.ABENA_API_KEY || 'sk_a47fce0855e54740887c863fa268e423',
