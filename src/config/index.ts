...
export const CONFIG = {
  ...
  ABENA_KEY_1: process.env.ABENA_KEY_1 || 'sk_d953bf290d394798baa9882dc82d95f5',
  ABENA_KEY_2: process.env.ABENA_KEY_2 || 'sk_6e293b7a2f92431a85a40814a211abcb',
  ABENA_API_KEY: process.env.ABENA_API_KEY || 'sk_d953bf290d394798baa9882dc82d95f5',
  ABENA_FALLBACK_API_KEY: process.env.ABENA_FALLBACK_API_KEY || 'sk_6e293b7a2f92431a85a40814a211abcb',
